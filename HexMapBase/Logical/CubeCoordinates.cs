...
namespace com.hexagonsimulations.Geometry.Hex
{
    ...
    public struct CubeCoordinates
	{
		...
		public OffsetCoordinates ToOffset()
		{
			...
			return new OffsetCoordinates( q, r );
		}
		...
		public 
		int 
		DistanceTo( CubeCoordinates other )
		{
		...
		public static 
		CubeCoordinates[] 
		Area( CubeCoordinates center, int range )
		{
			if ( range < 0 )
			{
		...
		public static 
		CubeCoordinates[] 
		IntersectRanges( CubeCoordinates[] a, CubeCoordinates[] b )
		{
		...
		public static 
		int 
		Distance( CubeCoordinates a, CubeCoordinates b )
		{
		...
		public static 
		CubeCoordinates[] 
		Line( CubeCoordinates start, CubeCoordinates end )
		{
